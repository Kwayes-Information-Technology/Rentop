...
class BillingAddressScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocConsumer<BillingAddressBloc, BillingAddressState>(
                      ...
                      children: [
                        RentopCards.rentopAppBar(
                          ...
                          backCallback: () => context
                              ...
                              .add(const BillingAddressEvent.clear()),
                        ),
                        const SizedBox(
                          height: 24,
                        ),
                ...
                child: Container(
                  ...
                  child: RentopButtons.rentopButton(
                    ...
                    onBtnPressed: () => context
                        .read<BillingAddressBloc>()
                        .add(const BillingAddressEvent.btnPressed()),
                    width: 200,
